...
function WebsiteContainer() {
  ...
  const displayName = selectedUser.name || selectedUser.fullName || "Website";
  const avatar = selectedUser.slug === "truly-pdf" ? "/icon-192.png" : selectedUser.favicon || "/avatar.png";
      ...
      <div className="flex h-16 shrink-0 items-center justify-between border-b border-[#1a1a1a] bg-[#0f0f0f]/90 px-4 md:px-6">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            <h3 className="truncate text-sm font-medium text-white md:text-base">{displayName}</h3>
